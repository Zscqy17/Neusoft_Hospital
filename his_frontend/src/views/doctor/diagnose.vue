<template>
    <el-container  style="">
        <el-aside class="el-aside" width="30%">
        ...
        <el-main style="margin-top:-20px;">
            <el-row :gutter="20">
                ...
                <el-col :span="4"><div class="grid-content " style="background: #F9F7EA;"><el-link :underline="false" icon="el-icon-success" @click="finishDiagnose">诊毕</el-link></div></el-col>
            </el-row>
