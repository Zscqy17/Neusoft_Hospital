<template>
  <div style="">
    <el-row :gutter="20" style="margin-top: 5px;width: 30%;">
      <el-col :span="10"><div class="grid-content bg-purple"style="border-radius: 4px;">评估/诊断</div></el-col>
      <el-col :span="10" v-show="cansee11"><div class="grid-content bg-purple"><el-link  @click="choosetype1">点击此处开始诊断疾病</el-link></div></el-col>
