<template>
  <div>
    <el-row :gutter="30">
      <el-col :span="6"><div class="grid-content" style="background: #F9F7EA;"><el-link icon="el-icon-s-order" @click="temporarysto">暂存</el-link></div></el-col>
      <el-col :span="6"><div class="grid-content " style="background: #F9F7EA;"><el-link icon="el-icon-success" @click="submit">提交</el-link></div></el-col>
      <el-col :span="6"><div class="grid-content " style="background: #F9F7EA;"><el-link icon="el-icon-delete" @click="refreshMsg">清空所有</el-link></div></el-col>
      <el-col :span="6"><div class="grid-content " style="background: #F9F7EA;"><el-link icon="el-icon-circle-plus" @click="refreshMsg" >刷新</el-link></div></el-col>
    </el-row>
