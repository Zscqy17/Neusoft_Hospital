<template>
  <div>
    <el-row :gutter="10">
      <el-col :span="5"> <el-link class="textleft color pos " style="font-size:20px;background: #68c3ff" @click="getDiagnose" >医生开药</el-link></el-col>
      <el-col :span="19"><div class="textleft color pos" style="background: #d6e3f7" >{{diagnosemsg}}</div></el-col>
    </el-row>
    <el-row>
      <el-col :span="3"><div class="grid-content bg-purple" style="background: #d5e2f6;"></div></el-col>
      <el-col :span="3"><div class="grid-content " style="background: #d0e2d1;"><el-link icon="el-icon-circle-plus-outline" @click="dialogVisible = true" :underline="false">增方</el-link></div></el-col>
      <el-col :span="3"><div class="grid-content" style="background: #d0e2d1;"><el-link icon="el-icon-remove-outline" @click="deletepre" :underline="false">删方</el-link></div></el-col>
      <el-col :span="3"><div class="grid-content" style="background: #d0e2d1;"><el-link icon="el-icon-circle-check" @click="openpre" :disabled="show" :underline="false">开立</el-link></div></el-col>
      <el-col :span="3"><div class="grid-content bg-purple"  style="background: #d0e2d1;"><el-link icon="el-icon-circle-close" @click="cancel" :underline="false">作废</el-link></div></el-col>
      <el-col :span="3"><div class="grid-content bg-purple-light"  style="background: #e2f4fe;"><el-link icon="el-icon-refresh" @click="refresh" :underline="false">刷新</el-link></div></el-col>
      <el-col :span="3"><div class="grid-content bg-purple"><el-link icon="el-icon-circle-plus" @click="beforeadddrug" :disabled="show" :underline="false">增药</el-link></div></el-col>
     ...
     <el-col :span="8">
       <el-card shadow="hover" class="box-card" :body-style="{ padding: '1px' }" >
          <div style="text-align: left;">
            <span><el-alert type="warning" style=" padding: 7px 15px" :closable="false">门诊处方</el-alert></span>
          </div>
          <div >
            <el-table
              :data="prescriptionlist"
              size="mini"
              @row-click="changprescriptionname"
