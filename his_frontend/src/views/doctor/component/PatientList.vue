...
<template>
  <el-container >
    <el-tag type="primary" style="text-align: right">待诊病人信息<el-link  :underline="false" type="info" @click="refresh1" icon="el-icon-refresh" style="margin-left: 110px;"></el-link></el-tag>
    <el-container>
      <el-main style=" padding:0 ;">
        <el-table  :stripe=true @row-click ="starttodiagnose" border height="170"
                  :data="tableDataEnd1"
                  style="width: 100%">
          <el-table-column
            label="病历号"
    ...
    <el-container>
      <el-main style="padding:0 ;">
        <el-table  :stripe=true  border  height="170"
                  :data="tableDataEnd2"
                  style="width: 100%">
          <el-table-column
            label="病历号"
    ...
    :visible.sync="patientdetailvisiable">
        ...
        <div v-for="(key,index) in p" :index="key">
          <el-row :gutter="20" style="text-align: left;margin-left: 200px;margin-top: 10px;">
            ...
            <el-col :span="7" style="background: #e2f4fe ;height: 20px;  border-radius: 4px;">{{index}}</el-col>
            <el-col :span="7"style="background: #e2f4fe;height: 20px; border-radius: 4px;">{{key}}</el-col>
            <el-col :span="5"></el-col>
          </el-row>
        </div>
