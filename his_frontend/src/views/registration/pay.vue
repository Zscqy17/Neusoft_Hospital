<template>
  <div  >
    ...
    <el-row >
      <el-col :span="4" style="text-align:left" ><el-button  type="success" @click="feeSettlement">费用结算</el-button></el-col>
    </el-row>
...
import {getPayType,startinvoice,feeSettlement,settlement,getpatientmsg,getPreMsg,settlement_1,} from "@/api/registration"
  export default {
    ...
    methods: {
      ...
      calculate_refee(){
        this.form.refee = (this.form.relpay-this.form.fee).toFixed(2);
      },
      ...
      feeSettlement(){
        ...
        if(this.registSelection.length===0){
          ...
          this.form.fee=this.form.fee.toFixed(2)
